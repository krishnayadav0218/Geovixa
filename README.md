# MTDC Attendance — Web App (Krystal Company)
...
5. Deploy hone ke baad URL milega, jaise `https://mtdc-krystal.onrender.com` — yahi link sabko (Employee/Manager/Admin) bhejna hai.
...
Made for **MTDC Project — Krystal Company**

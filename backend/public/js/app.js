...
async function loadProjects() {
  try {
    ...
    const selectIds = ['add-emp-project', 'edit-emp-project', 'filter-project', 'report-project', 'employee-report-project', 'add-mgr-project', 'add-coordinator-project'];
    ...
    const groupOptionIds = new Set(['add-mgr-project', 'add-coordinator-project']);

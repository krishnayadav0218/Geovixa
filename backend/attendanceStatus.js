...
// Loads every APPROVED leave_requests row that overlaps [fromDate, toDate] and expands each
// row's [from_date, to_date] span into individual calendar days, returning a Set of
// "employee_id|YYYY-MM-DD" keys. Call once per request (grid/report) and reuse it for every
// employee/date being rendered, same pattern as loadShiftThresholdsMap/loadWeeklyOffMap above.
async function loadApprovedLeaveMap(pool, fromDate, toDate) {

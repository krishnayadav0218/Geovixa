...
const { computeDayStatus, shiftCategoryLabel, loadShiftThresholdsMap, loadWeeklyOffMap, classifyShiftByLoginTime } = require('../attendanceStatus');
...
router.get('/summary-excel', async (req, res) => {
  ...
  employees.forEach(emp => {
    ...
    let totalP = 0, totalHD = 0, totalA = 0, totalWO = 0;
    dates.forEach(d => {
    ...
    // still counted as a payable day — the standard payroll convention).
